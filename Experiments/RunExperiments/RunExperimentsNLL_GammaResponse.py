...
from PFNExperiments.Training.TrainerCurriculumNLL import TrainerCurriculumNLL
...
from PFNExperiments.Evaluation.RealWorldEvaluation.PreprocessDataset import Preprocessor, PreprocessorClassification, PreprocessorGammaResponse
...
class RunExperiments():
    ...
    def evaluate_real_world(self):
        ...
        self.getdata = GetDataOpenML(
            preprocessor = PreprocessorGammaResponse(
